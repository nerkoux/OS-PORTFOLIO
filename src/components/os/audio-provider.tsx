...
export function AudioProvider({ children }: { children: ReactNode }) {
  ...
  const playSound = (soundName: string) => {
    ...
    console.log(`Audio disabled - would have played: ${soundName}`)
    return
  ...
  const setVolume = (volume: number) => {
    // Audio functionality disabled
    console.log(`Audio disabled - would have set volume to: ${volume}`)
    return
  ...
  const toggleMute = () => {
    // Audio functionality disabled
    console.log(`Audio disabled - would have toggled mute`)
    return
  ...
  const setEnabled = (enabled: boolean) => {
    console.log(`Audio enabled state changing from ${isEnabled} to ${enabled} (but audio is disabled)`)
